...
- [gotchas.md](.agent-docs/gotchas.md) — counter-intuitive lazy evaluation, empty-branch, reform-collision, collision-only directory validation, implicit path-to-store coercion, string-context propagation, per-file copy import breakage, and repeated tag-resolution behavior.
